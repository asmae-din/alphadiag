 ...
 */
?>
<div class="main-header <?php if( get_theme_mod( 'vw_medical_care_sticky_header', false) != '' || get_theme_mod( 'vw_medical_care_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
  <div class="container">
    <div class="row m-0">      
