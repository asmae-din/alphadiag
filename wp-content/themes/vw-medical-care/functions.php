...
function vw_medical_care_scripts() {
	...
	wp_enqueue_script( 'vw-medical-care-custom-scripts-jquery', esc_url(get_template_directory_uri()). '/assets/js/custom.js', array('jquery') );
	wp_enqueue_script( 'vw-medical-care-jquery-wow', esc_url(get_template_directory_uri()) . '/assets/js/wow.js', array('jquery') );
	wp_enqueue_style( 'vw-medical-care-animate-css', esc_url(get_template_directory_uri()).'/assets/css/animate.css' );
...
function vw_medical_care_tagline_hide_show(){
	if(get_theme_mod('vw_medical_care_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
